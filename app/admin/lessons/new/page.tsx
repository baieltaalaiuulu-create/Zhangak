        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 items-start">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 space-y-4">
            <div>
              ...
              <input value={title} onChange={e => setTitle(e.target.value)} placeholder="Сабактын аталышы"
            ...
            <div>
              ...
              <textarea value={description} onChange={e => setDescription(e.target.value)} rows={3} placeholder="Кыскача сүрөттөмө"
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold text-gray-500">YouTube шилтеме</label>
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <button type="button" onClick={() => handleSave(true)} disabled={saving}
                ...
                {saving ? 'Сакталууда...' : 'Сактоо (Активдүү)'}
              </button>
          ...
          <div className="lg:sticky lg:top-6">
            <div className="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-400">Алдын ала көрүнүшү</div>
