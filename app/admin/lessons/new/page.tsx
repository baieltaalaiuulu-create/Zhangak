    ...
    <div className="min-h-screen bg-[#FAF8FF]">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
          ...
          <button type="button" onClick={() => setCourseCreateOpen(true)} className="inline-flex min-h-10 items-center gap-1.5 rounded-xl border border-[#1B4FD8]/20 bg-white px-4 text-sm font-bold text-[#1B4FD8] hover:bg-blue-50"><Plus size={16} /> Новый курс</button>
        </div>
            ...
            <div>
              ...
              {coursesLoading ? (
                ...
                <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 px-4 py-4 text-sm text-gray-600">
                  ...
                  <button type="button" onClick={() => setCourseCreateOpen(true)} className="mt-2 font-bold text-[#1B4FD8] hover:text-blue-700">Создать курс</button>
                </div>
              ) : (
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
              ...
              <div className="space-y-4 p-5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-50 text-[#1B4FD8]"><BookOpen size={18} /></span>
                </div>
                <div>
                ...
                <span className="flex w-full items-center justify-center gap-1.5 rounded-xl bg-[#1B4FD8] py-2.5 text-sm font-bold text-white"><Play size={17} /> Начать урок</span>
              </div>
            </div>
