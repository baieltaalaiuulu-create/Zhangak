...
function validEnvironment() {
  ...
  process.env.ALLOWED_ORIGINS = 'https://platform.zhangak.com,https://offline.zhangak.com,https://admin.zhangak.com'
}
...
test('production configuration is fail-closed and localhost-bound by default', () => {
  ...
  assert.equal(config.allowedOrigins.has('https://offline.zhangak.com'), true)
})
