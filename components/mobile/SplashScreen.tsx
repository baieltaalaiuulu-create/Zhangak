...
// exactly 2s, then hands off to onDone (which advances to Onboarding).
export default function SplashScreen({ onDone }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#0D0D1A] md:hidden">
      <div className="h-24 w-24 overflow-hidden rounded-2xl shadow-[0_8px_28px_rgba(27,79,216,0.35)]">
        {/* eslint-disable-next-line @next/next/no-img-element -- static PWA icon, splash must not depend on next/image's optimizer */}
        <img src="/icons/icon-512.png" alt="Жангак" className="h-full w-full object-cover" />
      </div>
