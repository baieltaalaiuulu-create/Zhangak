...
import type { LessonView, PlatformLessonStatus } from '@/lib/platform-lessons'
...
function durationLabel(lesson: LessonView): string {
  return lesson.durationMinutes ? `${lesson.durationMinutes} мин` : 'Время не указано'
}
